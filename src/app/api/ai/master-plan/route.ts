...
- 例：「TOEIC 800点向けに、ビジネス単語と読解の穴埋めを中心に、毎日1問ずつランダムな形式で出題する」「RAGとLLMの実務を、中級者向けに用語解説とミニクイズで日替わりに提供する」など。
- 見出しや番号は不要。本文のみ。`;
}

const MOCK_MASTER_PLAN = `TOEIC 800点を目指す方に、ビジネスシーンでよく使う単語と読解の穴埋めを中心に、毎日1問ずつランダムな形式で出題します。難易度は中級を基準に、時々やさしめ・難しめを混ぜて定着を促します。`;
