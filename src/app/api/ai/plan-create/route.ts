...
## このプランのねらい
ユーザーの入力意図（出題数・テーマ・目標）を汲み取り、その内容・ボリュームが学習にどう役立つかを2〜4文で解説してください。

## 今後の方針（このような問題をランダムに出題します）
問題数・トピックを読み取り、具体的な出題例を${sampleCount}件、番号付きで列挙してください。各1行で、問題文またはトピックのタイトル＋一言でよいです。ユーザーのテーマに沿った多様な例にすること。
